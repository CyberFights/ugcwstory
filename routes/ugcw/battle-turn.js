/*
  ...
  MOVES
  -----
  move       type      power  acc  scaling                     recoil
  jab        swift      10    95   speed difference            -
  punch      strike     16    90   none, always reliable       -
  kick       strike     24    82   reach (height difference)   -
  headbutt   strike     20    85   toughness difference        20%
  tackle     charge     30    78   momentum (weight share)     15%
  throw      grapple    28    70   weight ratio                -
  guard      support     0   100   cuts the next hit by 55%    -
  recover    support     0   100   heals 22% of max hp         -
  ...
  guard_multiplier = 0.45 when the defender guarded on its last turn
  ...
  GET /ugcw/battle-turn?userid=naicul&self_height=180&self_weight=80
      &opponent_height=170&opponent_weight=60&move=kick
...
$ignore[==========================================================================
 STEP 15 - RESPOND: everything below has already been calculated and stored
==========================================================================]
...
$ignore[==========================================================================
 STEP 14 - PERSIST: save the new health points and the new turn
==========================================================================]
...
$ignore[==========================================================================
 STEP 13 - RESOLVE THE TURN: knock out, winner, next turn, round counter
==========================================================================]
...
$var[outcome;$ternary[$get[mv]==guard;guard;$ternary[$get[mv]==recover;recover;$ternary[$get[hit]==false;miss;$ternary[$get[crit]>1;critical;$ternary[$get[gmult]<1;guarded;hit]]]]]]

$ignore[==========================================================================
 STEP 12 - APPLY: damage to the defender, recoil and healing to the actor
==========================================================================]
...
$var[isattack;$ternary[$get[mv]==guard;0;$ternary[$get[mv]==recover;0;1]]]
...
$var[heal;$ternary[$get[mv]==recover;$fixed[$math[$get[amaxhp]*0.22];0];0]]
...
$ignore[==========================================================================
 STEP 11 - DAMAGE FORMULA
 damage = power * move_scale * attack_ratio * variance
                * effectiveness * guard_multiplier * critical
==========================================================================]

$var[damage;$ternary[$get[hit]==true;$get[dmgraw];0]]
$var[dmgraw;$fixed[$math[$get[base]*$get[scale]*$get[atkr]*$get[variance]*$get[eff]*$get[gmult]*$get[crit]];0]]
$var[gmult;$ternary[$get[dguard]==1;0.45;1]]
$var[crit;$ternary[$get[critroll]<10;1.6;1]]
$var[variance;$fixed[$math[(85+$get[rollvar])/100];2]]
...
$ignore[==========================================================================
 STEP 8 - MOVE TABLE: power, accuracy, type, recoil rate and the scaling
 formula each move uses. The scaling is written as plain math and then
 evaluated by math once the numbers are in place.
==========================================================================]

$var[scaleexpr;$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$get[mv];recover;1];guard;1];tackle;($get[aweight]*2)/($get[aweight]+$get[dweight])];throw;$get[aweight]/$get[dweight]];kick;1+($get[aheight]-$get[dheight])/200];headbutt;1+($get[atough]-$get[dtough])/200];punch;1];jab;1+($get[aspeed]-$get[dspeed])/150]]
$var[mtype;$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$get[mv];recover;support];guard;support];throw;grapple];tackle;charge];kick;strike];headbutt;strike];punch;strike];jab;swift]]
$var[acc;$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$get[mv];recover;100];guard;100];throw;70];tackle;78];kick;82];headbutt;85];punch;90];jab;95]]
$var[recoilrate;$ternary[$isNumber[$get[recoiltxt]]==true;$get[recoiltxt];0]]
$var[recoiltxt;$replaceText[$replaceText[$get[mv];tackle;0.15];headbutt;0.2]]
$var[base;$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$get[mv];recover;0];guard;0];tackle;30];throw;28];kick;24];headbutt;20];punch;16];jab;10]]
...
$ignore[==========================================================================
 STEP 4 - CHECK THE MOVE IS ONE OF THE EIGHT KNOWN MOVES
==========================================================================]

$if[$findSplitIndex[$get[mv]]==0;400;{"error": "Unknown move, valid moves are jab, punch, kick, tackle, throw, headbutt, guard, recover"}]
$split[jab/punch/kick/tackle/throw/headbutt/guard/recover;/]
