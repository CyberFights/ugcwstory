module.exports = { 
  ...
  "steps": "0",
  "current_map": "$get[map]",
  "height": "$getVar[$getQuery[userid]-sh]",
  "weight": "$getVar[$getQuery[userid]-sw]"
  }]
...
$setVar[terrain-ruincity2;x/ruincity4/x/x/x/x/x/-/-/-/-/-/x/x/x/x/x/-/x/x/x/x/x/-/x/x/x/x/x/-/x/x/x/x/x/ruincity1]
